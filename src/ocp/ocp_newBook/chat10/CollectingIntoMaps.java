 ...
 * sure that you understand each example before going on to the next one.
 **/
...
/*    When creating a map, you need to specify two functions. The first function tells the
     ...
     * You can rewrite s -> s as Function.identity(). It is not shorter and may or may not be clearer,
...
/*        This time we get the type that we specified. With us so far?
        This code is long but not particularly complicated. We did promise you that the code would be long!*/
    }
}
