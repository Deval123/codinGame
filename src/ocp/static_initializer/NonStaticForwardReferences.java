 ...
 * @author $ Devalère
 **/
public class NonStaticForwardReferences { //  Instance Initializers and Forward References
    { // (1) Instance initializer block.
        nsf1 = 10; // (2) OK. Assignment to nsf1 allowed.
        nsf1 = sf1; // (3) OK. Static field access in non-static field
    ...
    int nsf1 = nsf2 = 30; // (7) Non-static field. Assignment to
